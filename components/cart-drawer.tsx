              ...
              {lines.map((line) => (
                <li key={line.id} className="flex gap-4">
                  ...
                  <div className="flex flex-1 flex-col justify-between">
                    ...
                    <button
                      className="self-start text-xs text-ink-soft underline-offset-2 hover:text-ink hover:underline"
        ...
        {lines.length > 0 && cart && (
          <div className="border-t border-line px-6 py-7">
            ...
            <a
              ...
              className="block w-full bg-olive-deep py-4 text-center text-sm text-paper hover:bg-olive"
            >
              Checkout
            </a>
          </div>
